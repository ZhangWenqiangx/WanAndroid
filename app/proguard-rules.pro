...
#
-dontwarn com.example.module_home.composite.bean.**
-keep class com.example.module_home.composite.bean.** { *; }
-keep class com.example.module_home.data.** { *; }
-keep class com.example.module_home.home.bean.** { *; }
-keep class com.example.module_home.search.bean.** { *; }
